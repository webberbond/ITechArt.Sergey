...
public class FuncTestsSteps
{
    ...
    [Given(@"I click on the menu in the left corner of the site")]
    public void GivenIClickOnTheMenuInTheLeftCornerOfTheSite()
    {
        throw new NotImplementedException();
    }

    [Given(@"I click Logout button")]
    public void GivenIClickLogoutButton()
    {
        throw new NotImplementedException();
    }

    [Given(@"I see Login form")]
    public void GivenISeeLoginForm()
    {
        throw new NotImplementedException();
    }
